...
describe('post index', function () {
  ...
  it('lists the title of each post', function () {
    this.component.setState({ posts: this.posts });
    let renderedPosts = this.renderedDOM().querySelectorAll("li");
