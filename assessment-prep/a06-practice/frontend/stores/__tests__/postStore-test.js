...
xdescribe('post store', function () {
  ...
  it('#find finds a post by id', function () {
  ...
  it('receives a post from the approprate post action', function () {
  ...
  it('#all returns an array of stored posts', function () {
    PostStore.__set__("_posts", this.posts);
  ...
  it('receives a collection of posts from the appropriate post action', function () {
    let newPosts = [
