xdescribe('post edit', function () {
  ...
  it('contains title and body fields', function () {
    var post = { title: "TestTitle", body: "TestBody" }

    this.component.setState({post: post});

    var inputNodes = this.renderedDOM().getElementsByTagName('input');
    let inputValues = [];
